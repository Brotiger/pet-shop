		...
		<div class="menu_container menu_mm">
			<div class="page_menu_content">
				...
				<div class="page_menu_search menu_mm">
					<form action="#">
						<input type="search" required="required" class="page_menu_search_input menu_mm" placeholder="Поиск...">
					</form>
				</div>
				<ul class="page_menu_nav menu_mm">
					<li class="page_menu_item has-children menu_mm">
						...
						<ul class="page_menu_selection menu_mm">
							...
							<li class="page_menu_item menu_mm"><a href="{{ route('contacts') }}">Контакты<i class="fa fa-angle-down"></i></a></li>
						</ul>
					</li>
					<li class="page_menu_item has-children menu_mm">
			...
			<div class="row">
				<div class="col-lg-8 offset-lg-2">
					<div class="newsletter_content text-center">
						<div class="newsletter_title">Подписаться на рассылку новостей</div>
						<div class="newsletter_text"><p>Для получения новостей о новых товарах и скидках вы можете подписаться на нашу рассылку. Вы сможете отказаться от подписки в любой момент.</p></div>
			...
			<div class="row">
				<div class="col">
					<div class="footer_content d-flex flex-lg-row flex-column align-items-center justify-content-lg-start justify-content-center">
						<div class="footer_logo"><a href="/">SamaraComp.</a></div>
